...
namespace san
{
    ...
    public:
        ...
        virtual std::shared_ptr<san::QueryResult> run_query(const san::QueryType& query_type, const std::string& query, const std::string& columns_query);
        virtual std::shared_ptr<san::QueryResult> run_query(const san::QueryType& query_type, const std::string& query);
