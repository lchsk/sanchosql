...
class MainWindow : public Gtk::Window {
  ...
  private:
    ...
    // void cellrenderer_validated_on_editing_started(Gtk::CellEditable*
    // cell_editable, const Glib::ustring& path_string, const Glib::ustring&
    // new_text, san::SimpleTab* tab, san::SimpleTabModel* model, const
    ...
    void cellrenderer_validated_on_editing_started(
        ...
        const std::string& column_name);
    // void cellrenderer_validated_on_editing_started(Gtk::CellEditable*
    // cell_editable, const Glib::ustring& path) {};
