...
Preferences::Preferences()
    : PREFERENCES_PATH(
          g_build_filename(sancho::files::create_config_dir().c_str(),
...
void Preferences::save_values_to_file() {
    ...
    file.set_boolean("editor", "highlight_current_line",
...
bool Preferences::open_preferences_file() {
    try {
        ...
        // Preferences file is not really needed (does not exist until user
        // creates it)
...
void Preferences::load_values_from_file() { load_editor_settings(); }
...
void Preferences::load_editor_settings() {
    ...
    try {
        ...
        highlight_current_line =
            file.get_boolean(group, "highlight_current_line");
