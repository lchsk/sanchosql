...
PreferencesWindow::PreferencesWindow(BaseObjectType* cobject,
    ...
    builder->get_widget("check_highlight_current_line",
                        check_highlight_current_line);
    ...
    signal_show().connect(
        sigc::mem_fun(*this, &PreferencesWindow::on_win_show));
    signal_hide().connect(
        sigc::mem_fun(*this, &PreferencesWindow::on_win_hide));
...
void PreferencesWindow::set_color_schemes(
...
void PreferencesWindow::init() {
    ...
    check_highlight_current_line->set_active(
...
void PreferencesWindow::on_btn_apply_clicked() {
    ...
    preferences->highlight_current_line =
        check_highlight_current_line->get_active();
