...
namespace sancho {
namespace db {
Column::Column(const std::string& column_name, const std::string& data_type,
...
bool Column::is_nullable() const noexcept { return m_is_nullable; }
...
const std::string& ColumnMetadata::get_character_maximum_length() const
    noexcept {
    return m_character_maximum_length;
}

bool ColumnMetadata::get_is_nullable() const noexcept { return m_is_nullable; }
}
